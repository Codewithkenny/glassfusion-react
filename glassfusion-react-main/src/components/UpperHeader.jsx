    ...
    <div className="bg-[#D8DCE9] text-[#13084B] py-2">
      <div className="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-4 flex-wrap sm:space-x-6 justify-end mt-2 sm:mt-0 w-full sm:w-auto">
          ...
          <Link to="/contact">
            <button className="bg-[#00bbf0] text-white px-4 py-1 rounded-full transition-colors duration-300 hover:bg-transparent hover:text-white border border-white mt-2 sm:mt-0 ml-4 sm:ml-0 mb-2 sm:mb-0">
              Get a quote
            </button>
          </Link>
        </div>
